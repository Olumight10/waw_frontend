            ...
            <div className="relative z-10">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4 items-end">
                ...
                <FormSelect
                  ...
                  options={[
                    "None",
                    "16th International Leadership Summit 2026"
                  ]}
                ...
                <button
                  ...
                  className="bg-church-gold text-white py-3 px-4 rounded-sm text-[10px] font-bold uppercase shadow-lg"
                >
                  Verify & Pay
                </button>
              </div>
