...
export default function RegistrationLayout() {
  ...
  return (
    <>
          ...
          <div className="bg-white p-6 rounded-lg shadow-md border-t-4 border-church-gold">
            ...
            <div className="space-y-4 text-sm">
              <div className="flex gap-3">
                <span className="text-church-purple">01</span>
                <div>
              ...
              <div className="flex gap-3">
                <span className="text-church-purple">02</span>
                <div>
          ...
          <div className="lg:col-span-2 bg-church-purple p-8 rounded-lg shadow-xl text-white relative overflow-hidden">
            <div className="relative z-10">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4 items-end">
                ...
                <FormSelect 
                  label="SELECT EVENT" 
                  options={["None", "16th International Leadership Summit 2026"]} 
                ...
                <button 
                  ...
                  className="bg-church-gold text-white py-3 px-4 rounded-sm text-[10px] font-bold uppercase shadow-lg hover:bg-orange-600 transition-all"
                >
                  Verify & Pay
                </button>
              </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 items-start">
          ...
          <div className="lg:col-span-2 bg-white rounded-lg shadow-2xl p-10 border border-gray-100">
            ...
            <div className="space-y-10">
              ...
              <div>
                <label className="text-[10px] font-bold text-church-purple uppercase tracking-widest block mb-3">SPECIAL REQUIREMENTS / PRAYER REQUEST</label>
                <textarea 
                  className="w-full bg-gray-50 border border-gray-200 rounded-sm p-4 text-sm min-h-[140px] focus:outline-none focus:border-church-purple/30 transition-all" 
      ...
      {showQuickModal && (
        <QuickLoginModal 
          uniqueCode={quickRegister.member_code} 
          onSuccess={(code) => {
            localStorage.setItem("user_code", code);
            localStorage.setItem("isLoggedIn", "true");
            navigate("/dashboard");
